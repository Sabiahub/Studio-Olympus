...
import { Plus, MoreHorizontal, Loader2, Image as ImageIcon, X, Upload, ArrowUp, ArrowDown, Trash2 } from 'lucide-react';
...
export default function GuestsPage() {
  ...
  const openEditModal = (guest: any) => {
    ...
    setPortfolioImages(guest.portfolio_images ? [...guest.portfolio_images].sort((a: any, b: any) => (a.display_order || 0) - (b.display_order || 0)) : []);
    setIsModalOpen(true);
    setOpenDropdownId(null);
  };
